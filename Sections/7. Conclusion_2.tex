...
As discussed earlier, the optimal pruning dimensionality depends on the distribution of $Z$. The kNN and RkNN search processes induce different samples of $Z$, because their search origins, visited points, and pruning bounds are different. Therefore, this appendix estimates the parameters of the corresponding $f_Z$ separately for the kNN and RkNN cases.
