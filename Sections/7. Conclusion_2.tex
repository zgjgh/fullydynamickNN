...
\leq
\left(
\frac{45(\max_{1\leq k\leq D}\{\max\{\eta_{1k},\eta_{2k}\}\})^2}
{\iota\sum_{k=1}^{D}(b_k-a_k)^2(4a_k^2+7a_kb_k+4b_k^2)}
\right)^{\delta/2},
\label{equ:lemma_1_conclusion}
\end{equation}
where
\begin{align}
\eta_{1k}&=\left|a_k^2-\frac{\kappa_2(a_k^2+a_kb_k+b_k^2)}{3}\right|,
\label{equ:exp_kappa_2_left}\\
\eta_{2k}&=\left|b_k^2-\frac{\kappa_1(a_k^2+a_kb_k+b_k^2)}{3}\right|.
...
&\leq
\max\left\{
\left|b_k^2-\frac{\kappa_1(a_k^2+a_kb_k+b_k^2)}{3}\right|,
\left|a_k^2-\frac{\kappa_2(a_k^2+a_kb_k+b_k^2)}{3}\right|
\right\}
...
&\leq
\sum_{k=1}^{D}
(\max\{\eta_{1k},\eta_{2k}\})^{\delta} Var(Z_k^2) \notag\\
&\leq
\max_{1\leq k\leq D}
\{(\max\{\eta_{1k},\eta_{2k}\})^{\delta}\}
