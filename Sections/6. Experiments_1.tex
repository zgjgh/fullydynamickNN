...
All evaluated methods return exact kNN join results. We therefore do not compare against approximate kNN methods, whose recall-quality trade-offs are orthogonal to the exact maintenance problem studied here.
