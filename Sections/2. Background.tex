...
\subsection{Definitions and PCA Preliminaries}\label{sec:background-preliminaries}
...
We study exact fully dynamic kNN join on high-dimensional data: exactly maintain $\knnjoin(U,I)$ efficiently as both $U$ and $I$ are updated, with $D$ large enough that full-dimensional distance computation is a heavy cost.

\subsection{Hierarchical Index Building Blocks}\label{sec:index-building-blocks}
