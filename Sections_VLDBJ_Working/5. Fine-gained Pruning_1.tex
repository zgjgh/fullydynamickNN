...
For the strict pruning probability function in expression \ref{equ:ppd}, let $S(d)=\sum^{T}_{m=1}p_m\phi_m(a(d))$ denote the mixed density at the lower bound $a(d)$. Differentiating $a(d)=1/(k\ln(d)+b)$ gives
\begin{equation}
